...
admin.site.site_header = "Himi2"
admin.site.site_title = "Himi2 Admin Portal"
admin.site.index_title = "Himi2 Admin"

# swagger
api_info = openapi.Info(
    title="Himi2 API",
    default_version="v1",
    description="API documentation for Himi2 App",
)
